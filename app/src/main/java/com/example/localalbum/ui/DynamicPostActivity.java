 ...
 * @date 2015-5-14
 */
public class DynamicPostActivity extends BaseActivity implements OnClickListener, MatrixImageView.OnSingleTapListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.post_add_pic:
                Intent intent = new Intent(DynamicPostActivity.this, LocalAlbumActivity.class);
